...
$(ObjDir)/prbs31_test.c_pre.c.tb.o : prbs31_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) prbs31_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/prbs31.c_pre.c.tb.o : prbs31.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) prbs31.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
